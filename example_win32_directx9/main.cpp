...
void Colors() {
    ...
    style.Colors[ImGuiCol_WindowBg] = ImColor(113, 113, 113);
    style.Colors[ImGuiCol_ChildBg] = ImColor(113, 113, 113);
    style.Colors[ImGuiCol_Text] = ImColor(239, 239, 239);
    style.Colors[ImGuiCol_CheckMark] = ImColor(226, 224, 222);
    style.Colors[ImGuiCol_Button] = ImColor(219, 166, 50);
    style.Colors[ImGuiCol_CheckMark] = ImColor(237, 180, 56);
    style.Colors[ImGuiCol_ButtonActive] = ImColor(245, 200, 132);
    style.Colors[ImGuiCol_ButtonHovered] = ImColor(245, 200, 132);
    style.Colors[ImGuiCol_TabActive] = ImColor(245, 200, 132);
    style.Colors[ImGuiCol_Tab] = ImColor(219, 166, 50);
    style.Colors[ImGuiCol_Border] = ImColor(219, 166, 50);
    style.Colors[ImGuiCol_BorderShadow] = ImColor(219, 166, 50);
    style.Colors[ImGuiCol_TableHeaderBg] = ImColor(219, 166, 50);
    style.Colors[ImGuiCol_Header] = ImColor(219, 166, 50);
    style.Colors[ImGuiCol_FrameBgActive] = ImColor(102, 102, 117);
    style.Colors[ImGuiCol_FrameBg] = ImColor(102, 102, 117);
    ...
    while (!done)
    {
       ...
       // MENU OPTIONS
...

        {
            ...
            ImGui::Begin("Error.#1234", nullptr, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove | ImGuiTableFlags_Hideable | ImGuiWindowFlags_NoTitleBar);

            static bool Checkbox = true;
            ImGui::Text("_________________QuantumCheats Menu (Copy)_____________________________________________________");
